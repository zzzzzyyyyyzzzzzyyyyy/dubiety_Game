public class Manager{
    ...
    static String[] beginText = {
        ...
        "“As said before, I need 3 gems from the other side of the Line, as for what reason it is highly unimportant for you. I have asked another named Filliro to have a portal set straight into the center of where 3 doors lay, each with access to one of these gems. You have done tasks like this before so it should be of no trouble.”",
